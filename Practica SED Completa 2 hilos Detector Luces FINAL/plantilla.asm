...
MensajeBStop					;En subrutina de RECIBIR.INC
	DT "Bit Stop ", 0x00
MensajeErrorHayDosEmisores		;En subrutina de ELIGIR.INC
	DT "Error Hay 2 TX ", 0x00
MensajeErrorHayDosReceptores	;En subrutina de ELIGIR.INC
	DT "Error Hay 2 RX ", 0x00
MensajeEmisorEncontrado			;En subrutina de ELIGIR.INC
	DT "Emisor Found!", 0x00
MensajeReceptorEncontrado		;En subrutina de ELIGIR.INC
	DT "Receptor Found!", 0x00
